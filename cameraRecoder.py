...
serial_port = 'COM11'      # シリアルポートの設定：マイコン経由で超音波センサを接続したポートを指定する。未接続の
distance_threshold = 30    # 距離の閾値:超音波距離センサに近接した時に録画開始する(cm)。
line_access_token = 'x2mY2Joizz27DW8X9AHP7zwCFuKvcqjUkM8tLi9t4St' # LINE Notifyのアクセストークン
...
if serial_port != None or serial_port != "":
